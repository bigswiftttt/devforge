...
import { Search, Terminal, Bell, Settings, Menu } from "lucide-react";
            ...
            <header className="sticky top-0 z-50 flex items-center justify-between px-lg h-16 w-full bg-background/80 backdrop-blur-md border-b border-border">
                ...
                <div className="flex items-center gap-2">
                    <button
                        ...
                        className="hidden sm:flex p-2 text-muted-foreground hover:bg-muted rounded-lg transition-colors"
